...
from decision_transformer import DecisionTransformerRunner
...
cheetahTransformerRunner = DecisionTransformerRunner(None, cheetah_cfg, max_ep_len, train_ep_len, gamma, lr, weight_decay, warmup_steps, True, 
